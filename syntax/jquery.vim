...
" URL:         http://api.jquery.com/
 ...
 if exists("b:current_syntax") && b:current_syntax == 'javascript'
   ...
   syntax keyword javascriptQEvents         contained Event currentTarget isDefaultPrevented isImmediatePropagationStopped isPropagationStopped namespace pageX pageY
   preventDefault relatedTarget result stopImmediatePropagation stopPropagation target timeStamp which
   ...
   " syntax match   cssForms                  contained containedin=javascriptString
